                ...
                <div className="flex flex-wrap gap-4 items-center justify-between">
                 <h3 className="text-3xl xl:text-5xl text-primary font-bold">
                  ...
                  <div class="flex flex-wrap justify-end gap-3">
                    <button class="w-full xs:w-auto border border-grey rounded-full text-grey py-3 px-6 font-medium hover:border-primary hover:bg-primary hover:text-white ease-in-out duration-300 ">Add New Vehicle</button>
                    <button class="w-full xs:w-auto rounded-full flex justify-center gap-3 py-3 px-6 font-medium border-primary bg-primary text-white ease-in-out duration-300 "><Calendar className={'w-5'} /><span>07.02.2023 - 07.03.2023</span></button>
                  </div>
                </div>
